...
object GuideApi {
    suspend fun explainVision(language: String, image: String, question: String = ""): Result<String> = withContext(Dispatchers.IO) {
        ...
        runCatching {
            ...
            JSONObject().apply { put("language", language); put("image", image); put("question", question.take(1000)) }.toString().also { connection.outputStream.use { stream -> stream.write(it.toByteArray()) } }
